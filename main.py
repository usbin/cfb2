...
class Ui_StackedWidget(object):
    def setupUi(self, StackedWidget):
        ...
        self.verticalLayoutWidget_3.setGeometry(QtCore.QRect(0, 0, 733, 501))
    ...
    def retranslateUi(self, StackedWidget):
        ...
        self.label_3.setText(_translate("StackedWidget", "Push coffee after door opened."))
        self.label_4.setText(_translate("StackedWidget", "And click \"Done\" button."))
        self.pushButton.setText(_translate("StackedWidget", "Done"))
        self.label_5.setText(_translate("StackedWidget", "3"))
        self.label_6.setText(_translate("StackedWidget", "Door closed. Please be careful!"))
        ...
        self.label_11.setText(_translate("StackedWidget", "You point added successfully."))
        self.tb_point.setText(_translate("StackedWidget", "120 Point added."))
        self.tb_weight_measure.setText(_translate("StackedWidget", "Weight: 1.2Kg / Measure: 60cm^3"))
        self.tb_total_point.setText(_translate("StackedWidget", "Your total point : 10,260"))
import cfb_rc
